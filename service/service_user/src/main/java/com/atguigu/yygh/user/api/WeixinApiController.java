...
public class WeixinApiController {
    ...
    public String callback(String code,String state){
        ...
        //第二步，拿到code和微信id和密钥，请求微信固定地址，得到两个值
        ...
        try {
            ...
            //从返回字符串获取两个值poenid 和access_token
            ...
            if (userInfo==null){
                //第三步 拿着 openid和access_token请求微信地址，得到扫描人信息
            ...
            return "redirect:" +
                    ...
                    java.net.URLEncoder.encode((String) map.get("name"),"utf-8");
